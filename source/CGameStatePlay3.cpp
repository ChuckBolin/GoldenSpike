...
void CGameStatePlay3::Activate(){

}
//***************************************************************
//                         U P D A T E
//***************************************************************
CGameStateObject* CGameStatePlay3::Update(double timeDifference,  CGameData &data, CConfigData &cfg, CGraphics &con){
...
//                         R E N D E R 
//***************************************************************
void CGameStatePlay3::Render(CGraphics &con,  CGameData &data, CConfigData &cfg){
  //::ShowCursor(true);
  CLog *pLog = CLog::Instance();
  ...
  con.m_d3ddev->Clear(0, NULL, D3DCLEAR_TARGET | D3DCLEAR_ZBUFFER, D3DCOLOR_XRGB(50, 50, 0), 1.0f, 0);
  ...
  //player prompt
  con.Print("Game State Play THREE", F_V20B, cfg.ScreenWidth/2 - 90, 100, 255, 255, 255, 255);
...
/*
float CGameStatePlay3::GetDistance(CObject *obj1, CObject *obj2){
